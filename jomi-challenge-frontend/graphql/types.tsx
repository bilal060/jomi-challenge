...
export type ComponentCommonCarouselItemArgs = {
...
export type ComponentCommonTwoColumnBlock = {
...
export type HomePageSectionsDynamicZone = ComponentCommonCarousel | ComponentCommonHeader | ComponentCommonTwoColumnBlock | Error;
